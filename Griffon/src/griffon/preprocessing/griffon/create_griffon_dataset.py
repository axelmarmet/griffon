...
from griffon.coq_dataclasses import GriffonLemma, GriffonSample, GriffonStatement, MaskedCounTSample, Stage1Token, Stage2Sample, Stage2Statement, Stage2Token
