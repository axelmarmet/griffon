...
class GriffonDataModule(pl.LightningDataModule):
    ...
    def __init__(self, data_root:str, num_workers:int=4):
        super().__init__()
    ...
    def train_dataloader(self):
        return self.train_split.to_dataloader(self.num_workers)

    def val_dataloader(self):
        return self.valid_split.to_dataloader(self.num_workers)

    def test_dataloader(self):
        return self.test_split.to_dataloader(self.num_workers)
