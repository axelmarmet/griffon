...
import unittest
from griffon.models.copy_generator import CopyGenerator, CopyGeneratorLoss
...
test = TestCopyGeneratorLoss()
test.test_copy_loss_forward_shape()

test = TestCopyGenerator()
test.test_copy_gen_forward_shape()
